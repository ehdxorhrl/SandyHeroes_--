...
DebugMeshComponent::DebugMeshComponent(const std::shared_ptr<Object>& owner, Mesh* cube_mesh, Mesh* source_mesh)
	: MeshComponent(owner, cube_mesh), bounds_(source_mesh->bounds())
{
}
...
DebugMeshComponent::DebugMeshComponent(const std::shared_ptr<Object>& owner, Mesh* cube_mesh, const BoundingBox& bounds)
	: MeshComponent(owner, cube_mesh), bounds_(bounds)
{
}
...
DebugMeshComponent::DebugMeshComponent(const std::shared_ptr<Object>& owner, Mesh* cube_mesh, const BoundingOrientedBox& bounds)
	: MeshComponent(owner, cube_mesh)
{
	bounds_.Center = bounds.Center;
	bounds_.Extents = bounds.Extents;
