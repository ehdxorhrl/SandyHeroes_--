...
def process_file(filepath):
    ...
    content = re.sub(r'std::vector<Object\*>\s+monster_hit_particles_;', r'std::vector<std::weak_ptr<Object>> monster_hit_particles_;', content)
    ...
    content = re.sub(r'std::vector<Object\*>\s+sounds_;', r'std::vector<std::weak_ptr<Object>> sounds_;', content)
...
process_file("SandyHeroesClient/BaseScene.h")
