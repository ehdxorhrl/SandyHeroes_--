...
{
    std::cout << "총기 이름: " << gun_name_ << std::endl;
    std::cout << "총기 데미지: " << damage_ << std::endl;
}
...
void GunComponent::LoadGunInfo(const std::string& gun_name)
{
    ...
    std::cout << "총기 이름: " << gun_name << std::endl;
    std::cout << "총기 데미지: " << gun_info.damage << std::endl;
    std::cout << "총기 크뎀: " << gun_info.critical_damage_rate << std::endl;
    std::cout << "총기 rpm: " << gun_info.rpm << std::endl;
    std::cout << "총기 reload_time_: " << gun_info.reload_time << std::endl;
    std::cout << "총기 burst_num_: " << gun_info.burst_num << std::endl;
    std::cout << "총기 bullet_speed_: " << gun_info.bullet_speed << std::endl;
}
