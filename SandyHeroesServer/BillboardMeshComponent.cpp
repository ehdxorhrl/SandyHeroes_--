...
BillboardMeshComponent::BillboardMeshComponent(const std::shared_ptr<Object>& owner, Mesh* mesh) : MeshComponent(owner, mesh)
{
}
...
BillboardMeshComponent::BillboardMeshComponent(const std::shared_ptr<Object>& owner, Mesh* mesh, Material* material)
	: MeshComponent(owner, mesh, material)
{
}
...
BillboardMeshComponent::BillboardMeshComponent(const std::shared_ptr<Object>& owner, Mesh* mesh, Material* material, Scene* scene)
	: MeshComponent(owner, mesh, material), scene_(scene)
{
}
